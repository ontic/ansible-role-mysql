...
```
$ ansible-galaxy install ontic.mysql
```
...
```yml
- src: git+https://github.com/ontic/ansible-role-mysql.git
  version: master
  name: ontic.mysql
```
